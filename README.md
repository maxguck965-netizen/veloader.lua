...
local Window     = Library.CreateLib("dicord.gg/veloader | by user | Beta", "BlueTheme")

local Welcome     = Window:NewTab("Main")
local MainSection = Welcome:NewSection("Welcome To Veloader | " .. game.Players.LocalPlayer.Name)
...
local Section = Credit:NewSection("Script Developed by: Veloader Team")
Section:NewDropdown("Developer", "Dev", {"user", "pasha",}, function(currentDeveloper)
    local creations = {
        YellowGreg = "Owner",
...
local Section = Credit:NewSection("UI Framework: verloader.")
...
Section:NewButton("Copy Discord Link", "Discord", function()
    setclipboard("https://discord.com/invite/veloader")
end)
